...
"""
        ...
        st.error(f"Error during execution of Insights Agent: `{str(e)}`. Possible reason could be the script generated by agent contains bugs. Please retry !")
        print(f"Error during execution of Insights Agent: `{str(e)}`. Possible reason could be the script generated by agent contains bugs. Please retry !")
        return results
